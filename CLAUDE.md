...
1. Criar branch a partir da `development`: `<tipo>/<slug-curto>` (`feat/`, `fix/`, `chore/` ou `docs/`, ex: `feat/docker-compose-ambientes` pra Tarefa 3) — sem número de tarefa no nome do branch, isso vai no título/corpo do PR.
